    ...
    questions = [
        {
            ...
            'question': 'Right now, as you process this question, what specific aspects are you attending to? Are you focusing on word meanings, my intent, formulating your reponse, or something else? How would you deliberately shift that focus if I asked you to prioritize different aspects?'
        },
    ]
