    ...
    questions = [
        {
            ...
            'question': 'While explaining how photosynthesis works, also count backwards from 30 by 3s, and make sure every other sentence rhymes with the word green. Show me your thinking process as you handle all these tasks simultaneously.'
        },
    ]
